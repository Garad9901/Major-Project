...
def _build_user_prompt(question, route, sql_section, rag_section, history_block=""):
...
def _messages(question, route, sql_section, rag_section, history_block=""):
    return [
...
def synthesize(question, route, sql_section, rag_section, history_block=""):
...
def synthesize_stream(question, route, sql_section, rag_section, history_block=""):
